...
public class GameMenu extends Application{
	...
	private Parent createContent() {
		...
		try (InputStream is = Files.newInputStream(Paths.get("res/images/cod.jpeg"));
				InputStream fontStream = Files.newInputStream(Paths.get("res/fonts/cod_font.otf"))) {
	...
	private static class MenuBox extends StackPane {
		...
		public void hide() {
			TranslateTransition tt = new TranslateTransition(Duration.seconds(.5), this);
			tt.setToX((-300));
